          ...
          <section className="bg-slate-100 ">
            <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
              <Form
                ...
                className="w-full max-w-md px-8 py-8 rounded bg-slate-300 shadow-2xl shadow-slate-600"
              >
                <h1 className="text-3xl font-semibold text-gray-800 capitalize text-center dark:text-white">
                  Login Now
                </h1>
